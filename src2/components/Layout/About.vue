<template>
  ...
  >
    ...
    <div
      id="about"
      class="mx-auto grid max-w-2xl scroll-mt-10 grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10"
    >
      <div
      ...
      >
        <div class="lg:pr-4">
          <div class="lg:max-w-lg">
            <p class="text-base font-semibold leading-7 text-indigo-600">Why blah blah</p>
      ...
      <div
        class="-ml-12 -mt-12 p-12 leading-10 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden"
      >
        <figure
          class="mx-auto w-5/6 rounded-md bg-white px-5 py-3 text-gray-600 shadow-xl shadow-slate-300 outline-dashed outline-2"
        >
          <figcaption>
            <cite
              ><a
                ...
                <ArrowTopRightOnSquareIcon
                  class="inline-block h-3 w-3 flex-none align-super text-indigo-600"
                  aria-hidden="true"
                /> </a
            ></cite>
          </figcaption>
          <blockquote>
            <ol class="list-decimal p-5 pt-1 font-serif" start="52">
              <li class="pl-3">
                <span class="font-semibold">Duty of driver of vehicle in case of accident</span>

                <ol class="list-decimal pl-5" start="4">
                  <li class="pl-3">
                    Subject to paragraph (5), if a cat is hit by a motor vehicle while that vehicle
                    is being driven on a road, the driver of the vehicle must –

                    <ol class="list-latin pl-5">
                      <li class="pl-3">
                        stop the vehicle as soon as it is safe or reasonably practicable to do so;
                        and
                      </li>
                      <li class="pl-3">
                        ...
                        <ol class="list-roman pl-5">
                          <li class="pl-3">when the cat was hit, and</li>
                          <li class="pl-3">
          ...
          <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
            ...
            <ul role="list" class="mt-8 space-y-8 text-gray-600">
              <li class="flex gap-x-3">
                ...
                <span
                  ><strong class="font-semibold text-gray-900">Goal 1.</strong> Lorem ipsum, dolor
              ...
              <li class="flex gap-x-3">
                <LockClosedIcon class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span
                  ><strong class="font-semibold text-gray-900">Goal 2.</strong> Anim aute id magna
              ...
              <li class="flex gap-x-3">
                <LockClosedIcon class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span
                  ><strong class="font-semibold text-gray-900">Goal 3.</strong> Ac tincidunt sapien
            ...
            <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">What can I do?</h2>
            <p class="mt-6">
              Id orci tellus laoreet id ac. Dolor, aenean leo, ac etiam consequat in. Convallis arcu
              ipsum urna nibh. Pharetra, euismod vitae interdum mauris enim, consequat vulputate
              nibh. Maecenas pellentesque id sed tellus mauris, ultrices mauris. Tincidunt enim
...
<script setup>
import { ArrowTopRightOnSquareIcon, LockClosedIcon } from '@heroicons/vue/20/solid'
</script>
