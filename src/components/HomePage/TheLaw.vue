    ...
    <div class="mb-10 max-w-xl sm:text-center md:mx-auto md:mb-12 lg:max-w-2xl">
      ...
      >
        <span class="relative inline-block">
          ...
          <span class="relative">Jersey&rsquo;s</span>
        </span>
      ...
      <div>
        <p
          class="mb-6 mt-20 inline-block inline-flex items-center rounded-full bg-indigo-50 px-3 py-px text-xs font-semibold uppercase tracking-wider text-gray-900 transition-colors duration-200 hover:text-orange-900"
        >
          <a
